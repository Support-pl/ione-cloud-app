        ...
        <div v-if="!singleLoading" class="cloud__container">
          <div class="Fcloud">
                ...
                <div class="Fcloud__menu-btn icon__wrapper">
                  ...
                  >
                    ...
                    <a-row :gutter="[10, 10]">
                      ...
                      <a-col :xs="24" :sm="20">
                        <a-input-number :min="1" :max="32" v-model="resize.VCPU" />
                      </a-col>
                    </a-row>
                    <a-row :gutter="[10, 10]">
                      <a-col :xs="24" :sm="4"> RAM (GB) </a-col>
                      <a-col :xs="24" :sm="20">
                        <a-input-number :min="1" :max="64" v-model="resize.RAM" />
                      </a-col>
                    </a-row>
                  </a-modal>
            ...
            <div class="Fcloud__buttons">
              ...
              <div
                class="Fcloud__button disabled"
                :class="{
                  disabled: permissions.recover,
                  btn_disabled_wiggle: true,
                }"
                @click="false && openModal('recover')"
              >
                <div class="Fcloud__BTN-icon">
