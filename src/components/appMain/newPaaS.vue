              ...
              <a-row class="newCloud__prop" v-if="getAddons.traffic">
                ...
                <a-col span="16" :xs="18">
                  ...
                  >
                    ...
                    >
                      {{
                        group.description.TITLE.replace(
                ...
                <div
                  ...
                  @click="
                    () => {
                      ...
                      options.kind = tariff;
                      options.size = sizes[options.slide];
                    }
                  "
                >
  ...
  computed: {
    ...
    getFullPrice() {
      ...
      return [VMonly, ...addonsCosts]
        .reduce((acc, val) => acc + (val > 0 ? val : 0))
        .toFixed(tofixVal);
    },
    sliderIsCanNext() {
    ...
    currency() {
      const { currency_code } = this.$store.getters.get ?? {};
